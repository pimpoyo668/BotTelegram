...
def start(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text(
        'Que necesitas saber:\n\n'
        '0. Ubicacion Facultad de Cs. Exactas/ ubicacion \n'
...
def aulaVirtual(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text(
        ...
        '\n\nRetorna al principio amb /start\n\n'
    )
    update.message.reply_text(tornar)
...
def docentes(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_text(
        'Plantel docente: \n\n '
        '\u2705  /Teoria : \'Marcela Lopez d\'Box 19\n'
        '\u2705  /Teoria : \'Ariel Edgard Rivera d\'Box 27\n'
        '\u2705  /Practica: \'Carina Reyes d\'Box 3\n'
        '\u2705  /Practica: \'Cecilia Espinoza d\'Box 3\n'
        '\u2705  /Practica: \'Eduardo Fernandez d\'Box 3\n'
        '\u2705  /Practica: \'Claudia Ibarra d\'Box 3\n'
        '\u2705  /Practica: \'Claudio Vargas d\'Box 3\n'
        '\u2705  /Ayudante : \'Facundo Darfe d\'Box 3\n'
        '\n\nRetorna al principio amb /start\n\n'
...
def main():
    ...
    dispatcher.add_handler(CommandHandler("pandemia", docentes))
